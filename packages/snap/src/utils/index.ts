...
export const TOKEN_SYMBOL_MAP: Record<string, string> = {
	[POLYGON_MUMBAI_USDC_ADDRESS]: 'USDC',
	[POLYGON_MUMBAI_USDT_ADDRESS]: 'USDT',
	[POLYGON_MAINNET_USDC_ADDRESS]: 'USDC',
	[POLYGON_MAINNET_USDT_ADDRESS]: 'USDT',
	[ARBITRUM_MAINNET_USDC_ADDRESS]: 'USDC',
	[ARBITRUM_MAINNET_USDT_ADDRESS]: 'USDT'
}

export function getTokenSymbolByAddress(address: string) {
	return TOKEN_SYMBOL_MAP[address]
}
